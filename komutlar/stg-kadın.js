...
if(!['727100122974126132'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
const kadın = message.guild.roles.cache.find(r => r.id === '683401203895369802')
const kadın2 = message.guild.roles.cache.find(r => r.id === '727793466100285464')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '724916141645889558')
const savelogs = message.guild.channels.cache.find(c => c.id === '791989761962803220')
